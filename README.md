...
Также неизменяемый поток может создан с помощью метода *Latte.pack*, что позволяет быстро превратить
обычное значение в поток. Метод принимает значение, которое будет помещено в поток.
