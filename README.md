...
#### Arrow Latte.A ####
Помимо монады, также реализована простая стрелка работающая напрямую с монадами.
Конструктор стрелки принимает функцию, которая принимает значение и возвращает монаду.
...
Метод ladd принимает другую стрелку и добавляет ее перед текущей в вычислениях.
...
Метод radd принимает другую стрелку и добавляет ее после текущей в вычислениях.
