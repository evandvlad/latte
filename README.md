...
Методы: combine, any - принимают в качестве параметра единичный экземпляр (Promise/Stream) или массив экземпляров.
...
Метод комбинирующий текущий экземпляр с другим или списком других экземпляров Promise/Stream. В качестве результата
будет возврашаться массив данных от каждого экземляра.
...
Методы collectAll, collect, any в качестве параметра принимают список экземпляров Promise/Stream.

##### collectAll #####

Метод собирающий данные от экземпляров Promise/Stream в список, как успешные, так и нет, если есть хотя бы одно неуспешное 
...
Метод собирающий успешные данные от экземпляров Promise/Stream в список, если хотя бы один результат будет неуспешным, 
