...
если оно не удовлетворяет предикату, иначе оно остается без изменения и может передаваться далее по цепочке.
...
##### unless #####
Метод преобразования текущего успешного значения в значение E,
если оно удовлетворяет предикату, иначе оно остается без изменения и может передаваться далее по цепочке.
Используется для фильтрации.
