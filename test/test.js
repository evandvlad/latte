...
describe('puller > ', function(){
    ...
    describe('pull & apull', function(){
        ...
        it('with filter', function(done){
            ...
            s.set('best');  
            s.set('test');  
            s.set(Latte.L('error-1'));  
            p1 = p.pull(Latte.isR);
            s.set('west');
            p2 = p.apull(Latte.isR);
            p3 = p.pull(Latte.isR);
            
            s.set(Latte.L('error-2'));
            s.set('rest');
            s.set(Latte.L('error-3'));
            s.set('fest');
            s.set(Latte.L('error-4'));
