...
describe('Stream static methods > ', function(){
    ...
    describe('pack', function(){
        ...
        it('types', function(){
            var s1 = Latte.IStream.pack('test'),
                s2 = Latte.MStream.pack('test');
            
            assert.equal(Latte.isStream(s1), true);
            assert.equal(Latte.isStream(s2), true);
            assert.equal(Latte.isIStream(s1), true);
            assert.equal(Latte.isIStream(s2), false);
            assert.equal(Latte.isMStream(s1), false);
            assert.equal(Latte.isMStream(s2), true);
        });
             
        it('R', function(done){
            var spy = fspy(),
                s = Latte.IStream.pack('test');
        ...
        it('L', function(done){
            var spy = fspy(),
                s = Latte.IStream.pack(Latte.L('error'));
        ...
        it('Stream R', function(done){
            var spy = fspy(),
                s = Latte.IStream.pack(Latte.IStream.pack('test'));
        ...
        it('Stream L', function(done){
            var spy = fspy(),
                s = Latte.IStream.pack(Latte.IStream.pack(Latte.L('error')));
...
describe('recur', function(){
    ...
    it('L', function(done){
        ...
        Latte.recur(function(f, v){
            return Latte.IStream.pack(Latte.val(v)).fmap(function(val){
                return val + '!';
            }).when(function(v){
                return v.length < 8;    
            }).fmap(Latte.L).listen(f);
        })('test').listen(spy);
        
        setTimeout(function(){
            assert.equal(Latte.isL(spy.args[0]), true);
            assert.equal(Latte.val(spy.args[0]), 'test!!!');
            assert.equal(spy.count, 3);
            done();
        }, 100);
    });
    ...
    it('with context', function(done){
        ...
        Latte.recur(function(f, v){
            ...
            }, this).when(function(v){
                return v.length < 8;    
            }).listen(f);
        }, {sign : "!"})('test').listen(spy);
    ...
    it('return Stream', function(done){
        var spy = fspy(),
            s = Latte.gen(function*(v){
                ...
                return Latte.IStream.pack([v, x, y].join(','));
            })('test');
...
describe('puller', function(){
    ...
    it('pull R & L values', function(done){
        var s = Latte.MStream.shell(),
            p = Latte.puller(s.out()),
            spy1 = fspy(),
            spy2 = fspy(),
    ...
    it('apull R & L values', function(done){
        var s = Latte.MStream.shell(),
            p = Latte.puller(s.out()),
            spy1 = fspy(),
            spy2 = fspy(),
    ...
    it('pull more R values', function(done){
        var s = Latte.MStream.shell(),
            p = Latte.puller(s.out()),
            spy1 = fspy(),
            spy2 = fspy(),
    ...
    it('apull more R values', function(done){
        var s = Latte.MStream.shell(),
            p = Latte.puller(s.out()),
            spy1 = fspy(),
            spy2 = fspy(),
    ...
    it('not enough R values for pull', function(done){
        var s = Latte.MStream.shell(),
            p = Latte.puller(s.out()),
            spy1 = fspy(),
            spy2 = fspy(),
    ...
    it('not enough R values for apull', function(done){
        var s = Latte.MStream.shell(),
            p = Latte.puller(s.out()),
            spy1 = fspy(),
            spy2 = fspy(),
    ...
    it('too many init R values for pull', function(done){
        var s = Latte.MStream.shell(),
            p = Latte.puller(s.out()),
            spy1 = fspy(),
            spy2 = fspy(),
    ...
    it('too many init R values for apull', function(done){
        var s = Latte.MStream.shell(),
            p = Latte.puller(s.out()),
            spy1 = fspy(),
            spy2 = fspy(),
    ...
    it('shuffle emit & listeners for pull', function(done){
        var s = Latte.MStream.shell(),
            p = Latte.puller(s.out()),
            spy1 = fspy(),
            spy2 = fspy(),
    ...
    it('shuffle emit & listeners for apull', function(done){
        var s = Latte.MStream.shell(),
            p = Latte.puller(s.out()),
            spy1 = fspy(),
            spy2 = fspy(),
    ...
    it('with filter for pull', function(done){
        var s = Latte.MStream.shell(),
            p = Latte.puller(s.out()),
            spy1 = fspy(),
            spy2 = fspy(),
    ...
    it('with filter for apull', function(done){
        var s = Latte.MStream.shell(),
            p = Latte.puller(s.out()),
            spy1 = fspy(),
            spy2 = fspy(),
        ...
        p1 = p.apull(Latte.isR);
        s.set(Latte.L('error'));
        p2 = p.apull(Latte.isR);
        p3 = p.apull(Latte.isR);
    ...
    it('with filter with context for pull', function(done){
        var s = Latte.MStream.shell(),
            p = Latte.puller(s.out()),
            spy1 = fspy(),
            spy2 = fspy(),
        ...
        p1 = p.pull(function(v){
            return this.f(v);
        }, {f : Latte.isR});
        
        s.set(Latte.L('error'));
        
        p2 = p.pull(function(v){
            return this.f(v);
        }, {f : Latte.isR});
        
        p3 = p.pull(function(v){
            return this.f(v);
        }, {f : Latte.isR});
    ...
    it('with filter with context for apull', function(done){
        var s = Latte.MStream.shell(),
            p = Latte.puller(s.out()),
            spy1 = fspy(),
            spy2 = fspy(),
        ...
        p1 = p.apull(function(v){
            return this.f(v);
        }, {f : Latte.isR});
        
        s.set(Latte.L('error'));
        
        p2 = p.apull(function(v){
            return this.f(v);
        }, {f : Latte.isR});
        
        p3 = p.apull(function(v){
            return this.f(v);
        }, {f : Latte.isR});
